...
public class ConectaBanco {
    ...
    public void InserirSerie(DadosSerie p) throws SQLException {
        ...
        //stAcoesnoBanco.executeUpdate("INSERT INTO serie (`DT_FIM_SERIE`, `N_TEMPORADAS`, `NOME`, `DT_INICIO_SERIE`) VALUES ('"+p.getAnoFimSerie()+"', '"+p.getNumeroTemporadas+"', '"+p.getNome+"', '"+p.getAnoInicioSerie()+"'");
    }
